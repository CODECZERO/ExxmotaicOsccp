...
export default function TopNav() {
  ...
  return (
    <header className="fixed top-0 right-0 z-10 flex h-16 w-full md:w-[calc(100%-16rem)] items-center justify-between border-b border-slate-100 bg-white/80 px-4 md:px-8 backdrop-blur-md">
      <div>
